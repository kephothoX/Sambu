...
async def updateStopLoss(
    private_key: str, market_id: int, trade_side: bool, new_stop_loss_price: int
) -> dict:
    """
    Update the stop loss price for a specific market.
    ...
    Args:
        ...
        new_stop_loss_price (int): The new stop loss price.
    ...
    API_URL = f"{os.environ.get('KANA_BASE_URL')}/updateStopLoss"
    PARAMS = {
        "marketId": market_id,
