...
async def settlePNL(private_key: str, wallet_address: str, market_id: int) -> dict:
    """
    Settle the PNL for a specific market.
    ...
    API_URL = f"{os.environ.get('KANA_BASE_URL')}/settlePnl"
    PARAMS = {
